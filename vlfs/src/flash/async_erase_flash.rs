...
pub trait AsyncEraseFlash {
    ...
    fn erase_sector_4kib_nb(
        &mut self,
        address: u32,
    ) -> impl Future<Output = Result<(), Self::Error>>;
    fn erase_block_32kib_nb(
        &mut self,
        address: u32,
    ) -> impl Future<Output = Result<(), Self::Error>>;
    fn erase_block_64kib_nb(
        &mut self,
        address: u32,
    ) -> impl Future<Output = Result<(), Self::Error>>;

    fn suspend_erase(&mut self) -> impl Future<Output = Result<(), Self::Error>>;
    fn resume_erase(&mut self) -> impl Future<Output = Result<(), Self::Error>>;
    fn is_busy(&mut self) -> impl Future<Output = Result<bool, Self::Error>>;
    fn wait_erase_finish(&mut self) -> impl Future<Output = Result<(), Self::Error>>;
